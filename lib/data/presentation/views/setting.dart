              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyles.red15SemiBold.copyWith(
                    color: settingsProvider.isDark ? kColors[5] : kColors[0],
                  ),
                ),
              ],
            ),
              ...
              children: [
                Row(
                  children: [
                    Switch(
                      value:
                          settingsProvider.currentLocale.languageCode == 'ar',
                      onChanged: (isArabic) {
                ...
                Text(
                  settingsProvider.currentLocale.languageCode.toUpperCase(),
                  style: TextStyles.red15SemiBold.copyWith(
                    color: settingsProvider.isDark ? kColors[5] : kColors[0],
                  ),
                ),
